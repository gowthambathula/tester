 ...
 public class as9partB extends JApplet {
     private JTextField jtfOrder = new JTextField("0", 5);
     private as9partB.as9partBPanel trianglePanel = new as9partB.as9partBPanel();
     ...
     public as9partB() {
         ...
         this.jtfOrder.addActionListener(new ActionListener() {
             public void actionPerformed(ActionEvent e) {
                 as9partB.this.trianglePanel.setOrder(Integer.parseInt(as9partB.this.jtfOrder.getText()));
             }
         });
     }

     public static void main(String[] args) {
         JFrame frame = new JFrame("as9partB");
         as9partB applet = new as9partB();
         frame.add(applet);
     ...
     static class as9partBPanel extends JPanel {
         private int order = 0;
